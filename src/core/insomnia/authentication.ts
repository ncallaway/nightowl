...
import { AUTH_ASAP, AUTH_BASIC, AUTH_BEARER, AUTH_HAWK } from "../constants";
import { RenderedRequest } from "../insomniaTypes";
import { getBasicAuthHeader, getBearerAuthHeader } from "./headers";
...
export const getAuthHeader = async (renderedRequest: RenderedRequest, url: string) => {
